...
const Join = () => {
  return (
    <div className="md:w-[400px]  lg:h-[680px] h-[500px] flex w-full shadow-2xl rounded-xl relative">
      ...
      <div className="inner-shadow flex  flex-col gap-7 rounded-xl border-t-2 border-white bg-gradient-to-b from-black to-gray-900 px-6 py-6 text-white sm:px-8 sm:py-8 md:px-10 md:py-10">
       {/* img */}
        ...
        {/*Title  */}
        <h2 className="text-3xl font-[580] flex-grow mt-4 xsm:text-4xl md:text-5xl ">
