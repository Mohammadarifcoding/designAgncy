		...
		<div
			...
			<div className="flex flex-col md:flex-row items-center gap-6 ">
				<div
					...
					className="bg-[#292929] w-[70px] border border-white md:border-none h-[70px] md:p-3 md:h-full rounded-full flex items-center justify-center  md:w-[70px] order-4 md:order-first cursor-pointer">
				...
				<div className={`bg-[#292929] font-medium cursor-pointer p-4 rounded-full w-max text-white order-first md:order-last duration-300 ${isOpen ? "scale-0 absolute" : "scale-100"}`}>Login</div>
			</div>
